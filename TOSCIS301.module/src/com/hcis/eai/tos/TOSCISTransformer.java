...
public class TOSCISTransformer extends Transformer {
    private static final Logger log = LoggerFactory.getLogger(TOSCISTransformer.class);
	
	public TOSCISTransformer(String ifId) {
		super(ifId);
