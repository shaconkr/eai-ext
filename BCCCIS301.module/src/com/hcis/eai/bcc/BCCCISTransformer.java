...
public class BCCCISTransformer extends Transformer {
    private static final Logger log = LoggerFactory.getLogger(BCCCISTransformer.class);
	
	public BCCCISTransformer(String ifId) {
		super(ifId);
