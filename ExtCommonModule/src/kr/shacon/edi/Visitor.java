...
class Visitor extends AbstractSchemaVisitor {
  ...
  public void elementDecl(XSElementDecl element) {
    if (Constants.W3C_SCHEMA.equals(element.getType().getTargetNamespace())) {
      ...
      if (recordDefinition.isChoice() && modelGroup.getForeignAttribute(Constants.SHACON_KR_XSD, "setter") != null) {
        subDefinition.setSetterName(modelGroup.getForeignAttribute(Constants.SHACON_KR_XSD, "setter"));
      }
