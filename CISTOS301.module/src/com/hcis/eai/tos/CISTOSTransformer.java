...
public class CISTOSTransformer extends Transformer {
    private static final Logger log = LoggerFactory.getLogger(CISTOSTransformer.class);
	
	public CISTOSTransformer(String ifId) {
		super(ifId);
